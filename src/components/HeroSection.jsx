        ...
        <section className='flex flex-col md:flex-row items-center justify-center gap-5 md:gap-40 text-center md:text-left min-h-screen max-w-5xl mx-auto px-4'>
            ...
            <div className='w-full md:w-1/2 flex flex-col gap-5'>
                ...
                <a href={Resume} download>
                    <button className='rounded-3xl p-2 w-25 md:w-35 md:text-md transition duration-300 ease-in-out hover:cursor-pointer hover:scale-107 bg-[var(--btn-color)] text-[var(--btn-text-color)]'>Resume</button>
